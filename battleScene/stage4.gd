...
const SPAWN_INTERVAL_SECONDS: float = 3.85 # 比基础快30%(5.0/1.3)
const INITIAL_MONSTER_LIMIT: int = 39 # 基础30提升30%
const MONSTER_LIMIT_INCREASE_WAVE_STEP: int = 2
const MAX_MONSTER_CAP: int = 104 # 基础80提升30%
...
# FOREST: shen(6), frog_new(2), slime_green(3), ball(3)
