...
const SPAWN_INTERVAL_SECONDS: float = 4.17 # 比基础快20%(5.0/1.2)
const INITIAL_MONSTER_LIMIT: int = 36 # 基础30提升20%
const MONSTER_LIMIT_INCREASE_WAVE_STEP: int = 2
const MAX_MONSTER_CAP: int = 96 # 基础80提升20%
...
# CAVE: ghost(4), armor_stone(4), stone_man(1), slime_green(1)
...
func _on_warning_finished() -> void:
	...
	boss_node.position = Vector2(-15, 240)
