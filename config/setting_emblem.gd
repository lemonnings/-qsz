...
func _initialize_emblem_configs():
	...
	emblem_configs["jinghong"] = EmblemData.new(
		...
		5,
		"{base_weapon}每攻击3次，额外攻击1次，该次攻击造成12*层数%的伤害。"
	)
	...
	emblem_configs["lianti"] = EmblemData.new(
		...
		5,
		"每1%的减伤率额外提升0.1*层数%的最终伤害，最多提升20%。"
	)
	...
	emblem_configs["jianbu"] = EmblemData.new(
		...
		5,
		"领悟获得的每4%移速可以提升0.25*层数%的攻击与0.25*层数%的体力上限，最多提升20%。"
	)
	...
	emblem_configs["jiahu"] = EmblemData.new(
		...
		5,
		"领悟获得的每点额外天命可以提升0.15*层数%的攻击与0.15*层数%的体力上限，最多提升20%。"
	)
	...
	emblem_configs["guiyuan"] = EmblemData.new(
		...
		5,
		"领悟获得的每10%攻速可以提升0.15*层数%的攻击与0.15*层数%的体力上限，最多提升20%。"
	)
	...
	emblem_configs["manli"] = EmblemData.new(
		...
		5,
		"使局外的移动速度加成失效，且当移动速度加成<0%时，提升5*层数%的最终伤害。"
	)
	...
	emblem_configs["ronghui"] = EmblemData.new(
		...
		5,
		"当前每拥有一个纹章，提升1.5*层数%最终伤害，每层最多提供10%。"
	)
