...
const INITIAL_FACTION_WEIGHTS: Dictionary = {
	"normal": 2.0,           # 通用，通用型、基础属性提升
	"wild": 1.0,           # 狂野，以暴击率，暴击伤害，狼助战为主
	"blood": 0.0,           # 嗜血，以1血，靠次数护盾生存，并得大量增益为主
	"summon": 25.0,           # 召唤，召唤物数量、召唤物属性提升等
	"bullet": 25.0,           # 剑气，弹体大小、反弹、分裂（三向、五向）等
	"lukcy": 1.0,           # 天命，与幸运值、特殊几率触发等相关的
