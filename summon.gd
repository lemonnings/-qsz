...
func fire_directed_bullets() -> void:
	...
	var bullet_direction = Vector2(horizontal_dir, 0).normalized()
...
func fire_tracking_bullet() -> void:
	...
	if target_enemy:
		...
		create_bullet(direction, 0.4, 2.0)  # 子弹速度提升100%
...
func fire_enhanced_tracking_bullets() -> void:
	...
	if target_enemy:
		...
		create_bullet(direction1, 0.45, 2.0)
		create_bullet(direction2, 0.45, 2.0)
