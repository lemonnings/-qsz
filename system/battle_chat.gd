...
func _build_idle_chats() -> void:
	_idle_chats = [
		...
		{
			"lines": [
				{"speaker": "墨宁", "text": "小秋，别只顾着追最近的敌人，先看周围有没有被围住。"},
				{"speaker": "言秋", "text": "知道知道！我眼睛可灵着呢。"},
				{"speaker": "墨宁", "text": "你上次也是这么说的，然后撞进了怪堆里。"},
				{"speaker": "言秋", "text": "呃……那是它们围得太快了！"},
			],
		},
		{
			"lines": [
				{"speaker": "墨宁", "text": "幻境会记录我们的战斗方式，后面的敌人可能会越来越难缠。"},
				{"speaker": "言秋", "text": "那我们就换着法子打！它总不能什么都学会吧？"},
			],
		},
		{
			"lines": [
				{"speaker": "言秋", "text": "等回镇子上，我要吃两碗热汤面。"},
				{"speaker": "墨宁", "text": "先打完这一轮再说？"},
		...
		},
		{
			"lines": [
				...
				{"speaker": "言秋", "text": "精确到我差点以为自己要倒下啦？"},
		...
		},
		{
			"lines": [
				...
				{"speaker": "言秋", "text": "你直接说它们要包过来不就好了！"},
		...
		},
		{
			"lines": [
				...
				{"speaker": "坎塞尔", "text": "我只是在判断最短施法距离。"},
				{"speaker": "诺姆", "text": "那也先告诉我们一声！"},
		...
		},
		{
			"lines": [
				...
				{"speaker": "墨宁", "text": "不是普通的风。它们像是在回应幻境的核心。"},
				{"speaker": "言秋", "text": "那就把核心揪出来！"},
			],
			"stage_only": "forest",
		},
		{
