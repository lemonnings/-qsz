...
var pages: Array = [
	{
		"title": "教程：神秘商铺",
		"image": "res://AssetBundle/Sprites/image/town_kan.png",
		"detail": "可以在坎的神秘商铺处购买坎的稀有物品了，通关后或通过进货单可刷新商铺陈列的商品。\n基础货币为修仙界通用的灵石，商铺里面会刷新出来用真气购买的灵石，也可以在炼丹炉处通过熔炼灵石碎片获得大量灵石。\n商铺可以花费材料与灵石升级，升级后，刷新出稀有物品概率提升。\n超出使用数量上限的丹药可以回收获得部分灵石。"
	}
]
